...
<%
  ...
  try{
	  ...
	  ResultSet rs1=st.executeQuery("select sum(total) from cart where email='"+email1+"' and address is NULL");
	  while(rs1.next()){
		  total=rs1.getInt(1);
	  }
...
<div class="left-div">
<h3>Enter State</h3>
<input class="input-style" type="text" name="address" value="<%=rs2.getString(9) %>" placeholder="enter state">
</div>
...
<h3>Select way of Payment</h3>
 <select class="input-style" name="onlinePayment">
